...
import { DOMAIN_CARDS } from '../data/domainProjects.js';
  ...
  const handleEnquire = () => {
    ...
    if (onNavigate) {
      onNavigate('contact', {
        ...
        sourceTab: 'Home',
        message: `Inquiry from Home showcase for ${product.name} (Ref #${product.number}).`,
      });
    }
  };
    ...
    <div className="page-container page-enter home-page-wrapper">
      ...
      <HeroSection
        ...
        onNavigateContact={() => onNavigate('contact', {
          enquiryType: 'Lab Consultation',
          domain: 'Robotics & AI',
          sourceTab: 'Home',
          message: 'Scheduling a technical laboratory consultation from the home hero section.',
        })}
      />
            ...
            <div className="home-banner-actions">
              ...
              <button
                ...
                onClick={() => onNavigate('contact', {
                  enquiryType: 'Custom Quotation',
                  domain: 'Hardware Kits & Robotics',
                  sourceTab: 'Home',
                  message: 'Requesting a custom quote for robotics hardware and engineering kits.',
                })}
              >
          ...
          <div className="home-domains-grid">
            {DOMAIN_CARDS.map((domain) => (
              <div
                ...
                onClick={() => {
                  try {
                    sessionStorage.setItem('robogenesis_selected_domain', domain.id);
                  } catch (e) {}
                  onNavigate('domains');
                }}
                role="button"
