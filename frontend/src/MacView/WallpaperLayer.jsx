...
const WALLPAPER_SLIDES = [
  { id: 'image1', src: image1, title: 'Robogenesis Workspace 1' },
  { id: 'image2', src: image2, title: 'Robogenesis Workspace 2' },
  { id: 'image3', src: image3, title: 'Robogenesis Workspace 3' },
];
...
export default function WallpaperLayer({ wallpaper }) {
  ...
  return (
    <div className="os-desktop-slideshow-container" aria-label="Robogenesis Dynamic Workspace Slideshow">
