...
const VALID_PAGES = ['home', 'about', 'domains', 'products', 'web-development', 'contact'];
  ...
  useEffect(() => {
    ...
    if (prevPage && prevPage !== currentPage) {
      ...
      if (prevIdx !== -1 && nextIdx !== -1 && prevIdx !== nextIdx) {
        ...
        const targetName = currentPage === 'web-development' ? 'Web Development' : (currentPage.charAt(0).toUpperCase() + currentPage.slice(1));
